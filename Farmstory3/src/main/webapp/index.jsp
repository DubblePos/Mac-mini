...
<main>
    ...
    <div class="quick">
        <a href="/Farmstory3/board/list.do?group=Community&cate=menu"><img src="./img/main_banner_sub1_tit.png" alt="오늘의 식단"></a>
        <a href="/Farmstory3/board/list.do?group=Community&cate=chef"><img src="./img/main_banner_sub2_tit.png" alt="나도 요리사"></a>                
    </div>

    <div class="latest">
        <div>
            <a href="/Farmstory3/board/list.do?group=Croptalk&cate=grow"><img src="./img/main_latest1_tit.png" alt="텃밭 가꾸기"/></a>
        ...
        <div>
            <a href="/Farmstory3/board/list.do?group=Croptalk&cate=school"><img src="./img/main_latest2_tit.png" alt="귀농학교"/></a>
        ...
        <div>
            <a href="/Farmstory3/board/list.do?group=Croptalk&cate=story"><img src="./img/main_latest3_tit.png" alt="농작물 이야기"/></a>
